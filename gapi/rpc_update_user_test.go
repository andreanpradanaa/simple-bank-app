...
import (
	...
	mockdb "github.com/andreanpradanaa/simple-bank-app/db/mock"
	...
	mockwk "github.com/andreanpradanaa/simple-bank-app/worker/mock"
...
func (expected eqCreateUserTxParamsMatcher) Matches(x interface{}) bool {
	...
	err = actualArg.AfterCreateUser(expected.user)
	return err == nil
}
...
func TestCreateUserAPI(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			ctrlDistributor := gomock.NewController(t)
			defer ctrlDistributor.Finish()
			taskDistributor := mockwk.NewMockTaskDistributor(ctrlDistributor)
