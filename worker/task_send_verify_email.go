...
const TaskSendVerifyEMail = "task:task_send_verify_email"
...
func (processor *RedisTaskProcessor) ProcessTaskSendVerifyEmail(ctx context.Context, task *asynq.Task) error {
	...
	verifyUrl := fmt.Sprintf("http://localhost:8081/v1/verify_email?email_id=%d&secret_code=%s", verifiedEmail.ID, verifiedEmail.SecretCode)
